...
export const GaleryFav = () => {
  ...
  return (
    <div className="flex flex-wrap justify-center xl:justify-start items-end my-7">
       {/* <button onClick={() => dispatch(addFavorite("a93359d0-2cd1-4007-ba25-fe6ea719bb17",userId))}>Favorite</button>
      <button onClick={() => dispatch(addFavorite("4371f25c-85ea-4ee7-a0b6-863a68234075",userId))}>Favorite</button>
