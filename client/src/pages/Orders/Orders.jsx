  ...
  return (
    <div className="flex flex-col items-center container m-auto my-10">
      {userType === "Admin" ? (
        ...
        >
          <div className="flex justify-center items-center w-96 pl-7">
          ...
          <div className="flex justify-center items-center w-[24rem] text-primary">
          ...
          {userType === "User" ? (
            ...
            >
              <div className="flex justify-center items-center w-96 pl-6">
                <p className="text-3x1 text-primary cursor-pointer">YOUR ORDER ID</p>
              </div>
